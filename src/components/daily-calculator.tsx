    ...
    <main className="app-shell">
      ...
      {activePeriod === "day" ? <section className="workspace" aria-label="Calculator zilnic">
        ...
        <aside className="result-column" aria-live="polite">
          ...
          </dl></section> : <section className="breakdown-card"><p className="eyebrow">Calcul transparent</p><h2>Detaliile apar după completare</h2><p>Pentru un calcul corect, ProfitExact nu estimează automat comisionul. Introdu suma exactă afișată de aplicația de ridesharing.</p></section>}
