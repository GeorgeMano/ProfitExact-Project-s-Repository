  ...
  return (
    <main className="landing-shell">
      ...
      <section className="audience-section" id="pentru-cine">
        <div><p className="landing-kicker">Alegi forma de lucru</p><h2>Două categorii principale. Restul se adaptează situației tale.</h2><p>Începi cu forma în care lucrezi, apoi alegi ridesharing, delivery sau ambele. ProfitExact îți arată doar întrebările, platformele și costurile care se potrivesc alegerilor tale.</p></div>
        <div className="audience-cards"><article><span>Categoria 1</span><h3>Angajat</h3><p>Alegi apoi ridesharing, delivery sau ambele. Dacă lucrezi cu o flotă, se configurează comisionul, CIM-ul și celelalte costuri datorate flotei.</p></article><article><span>Categoria 2</span><h3>Dețin propriul SRL/PFA</h3><p>Alegi SRL sau PFA, apoi activitatea și platformele. Costurile administrative și fiscale apar numai după ce se confirmă situația reală.</p></article></div>
      </section>
